...
app.get('/login', (req, res) => {
    res.render('login',{title: 'Entry form',  passMessage: 'Пароль допускает строчные и прописные латинские буквы, цифры, спецсимволы. Минимум 8 знаков.'});
});
...
app.post('/login', (req, res, next) => {
    passport.authenticate('local', function (err, user) {
        ...
        if (!user) {
            ...
            return res.render('login',{title: 'Login',  passMessage: 'Пользователь не идентифицирован.'});
        ...
        req.logIn(user, function (err) {
            ...
            return res.render('mainAuth',{title: 'Programs Page Authenticated'});
        });
    })(req, res, next);
});
